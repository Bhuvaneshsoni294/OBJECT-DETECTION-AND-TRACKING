...
def drawBox(img,bbox):
    ...
    cv2.rectangle(img,(x,y),((x+w),(y+h)),(255,100,250),2)

    cv2.putText(img,"TRAKING",(75,90),cv2.FONT_HERSHEY_DUPLEX,0.7,(255,150,240),2)
...
while True:
   ...
   if success:
       ...
       cv2.putText(img,"LOST",(75,90),cv2.FONT_HERSHEY_DUPLEX,0.7,(255,150,240),2)
